...
int main( int argc, char* argv[] )
{
    ...
    vtkSmartPointer< VoronoiFilter > vor =
        vtkSmartPointer< VoronoiFilter >::New( );
    vor->SetInputData( input_data );
    vor->Update( );

    // 12. Prepate voronoi diagram visualization
    ActorMiniPipeline vor_actor;
